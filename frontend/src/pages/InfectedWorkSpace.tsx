...
export const InfectedWorkSpace: React.FC = () => {
    ...
    useEffect(() => {
        setInfected(findByIID(params.id!));
    })
                    ...
                    <div className="flex flex-col grow h-full">
                        <div className="flex-1 min-h-0 bg-gray-900 rounded-t-xl p-4 shadow-inner overflow-hidden">
                            <div className="h-full overflow-y-auto pr-2 space-y-2 flex flex-col justify-end">
                                {commandResults.map(({input: cmdInput, output}) => {
                        ...
                        <input
                            ...
                            className="w-full p-4 font-mono bg-gray-900 rounded-b-xl text-lg outline-none text-white placeholder-white focus:bg-slate-gray-700 transition-colors"
                        />
                    </div>
                }
                {
